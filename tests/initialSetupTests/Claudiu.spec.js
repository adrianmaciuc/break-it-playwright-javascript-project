...
test("Verify if only four lumas items are listed on whats new page", async ({
  page,
}) => {
...
test("Verify if by Clicking on  Stellar Solar Jacket the page is redirect to the clicked product", async ({
  page,
}) => {
  await page.goto("https://magento.softwaretestingboard.com/what-is-new.html");
